            ...
            {expanded && (
              <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] }} className="overflow-hidden">
                <div className="px-8 pb-8 pt-2">
                  ...
                  <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="text-center text-sm text-muted mt-5">Most agencies disappear after delivery. We stick around so you never have to think about any of this.</motion.p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
