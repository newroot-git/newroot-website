...
const steps = [
  {
    number: "01",
    title: "Brief us",
    description: "Quick call. Right questions. Clear plan.",
    detail: "30 min",
    visual: (
        ...
        <motion.div initial={{ scale: 0.8, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.2 }}
          ...
          <div className="w-20 h-20 rounded-2xl bg-accent/[0.06] flex items-center justify-center">
            <motion.svg animate={{ rotate: [0, 5, -5, 0] }} transition={{ duration: 4, repeat: Infinity }} className="w-8 h-8 text-accent" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <motion.path d="M8 9h8M8 13h4" initial={{ pathLength: 0 }} whileInView={{ pathLength: 1 }} viewport={{ once: true }} transition={{ duration: 1, delay: 0.5 }} />
            </motion.svg>
          </div>
        </motion.div>
      </div>
  ...
  },
  {
    number: "02",
    title: "We build",
    description: "Custom design + code. No templates.",
    detail: "5-10 days",
    visual: (
      <div className="relative h-28 mb-4">
        <motion.div initial={{ scale: 0.8, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }}
          className="absolute inset-0 flex items-center justify-center">
          <div className="w-20 h-20 rounded-2xl bg-accent/[0.06] flex items-center justify-center relative">
            <motion.svg className="w-8 h-8 text-accent" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <motion.line x1="14" y1="4" x2="10" y2="20" initial={{ pathLength: 0 }} whileInView={{ pathLength: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.6 }} />
            </motion.svg>
  ...
  },
  {
    number: "03",
    title: "You launch",
    description: "Go live. We keep it growing.",
    detail: "Ongoing",
    visual: (
      <div className="relative h-28 mb-4">
        <motion.div initial={{ scale: 0.8, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.6 }}
          className="absolute inset-0 flex items-center justify-center">
          <div className="w-20 h-20 rounded-2xl bg-accent/[0.06] flex items-center justify-center">
...
export default function W4wHowItWorks() {
  return (
      ...
      <div className="max-w-[1280px] mx-auto">
        <div className="text-center mb-16">
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            Stupidly{" "}<span className="font-display italic font-normal text-accent">simple.</span>
          </motion.h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-3 mb-12 relative">
          ...
          {steps.map((step, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.2 }} whileHover={{ y: -4 }}
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          {[
            ...
            <motion.div key={i} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.8 + i * 0.1 }}
