...
const benefits = [
  {
    title: "Creative Director quality",
    description: "Real design taste. Not AI slop.",
    span: 2,
    accentBg: false,
    visual: (
      <div className="flex gap-2 mb-4">
        {[0, 1, 2].map((i) => (
          <motion.div key={i} initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} whileHover={{ y: -3, rotate: -2 }}
  ...
  },
  {
    ...
    description: "AI-accelerated delivery.",
    span: 1,
    accentBg: true,
    visual: (
      <motion.div className="text-[48px] font-bold leading-none mb-3 text-white/90" initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 200 }}>
  ...
  },
  {
    ...
    description: "Every decision earns its place.",
    span: 1,
    accentBg: false,
    visual: (
  ...
  {
    title: "No templates",
    description: "Everything custom. Always.",
    span: 1,
    accentBg: false,
    visual: (
  ...
  },
  {
    ...
    description: "AI is our tool, not our replacement.",
    span: 2,
    accentBg: false,
    visual: (
...
export default function W4wBenefits() {
  return (
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-3">
          {benefits.map((benefit, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }} whileHover={{ y: -4 }}
