...
const problems = [
  {
    title: "Looks like 2019", description: "Visitors judge in 0.05 seconds.",
    visual: (
  ...
  {
    title: "Slow as hell", description: "3 seconds = 53% bounce rate.",
    visual: (
  ...
  {
    title: "Not converting", description: "Traffic up, revenue flat.",
    visual: (
  ...
  {
    title: "DIY disaster", description: "Built at 2am. It shows.",
    visual: (
...
export default function W4wProblems() {
  return (
    <section className="py-[140px] px-6">
      <div className="max-w-[1280px] mx-auto">
        ...
        <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="font-sans font-bold text-[clamp(36px,4vw,56px)] leading-[1.1] tracking-[-0.025em] max-w-[650px] mb-16">
          Is your website{" "}<span className="font-display italic font-normal">costing you?</span>
        </motion.h2>
